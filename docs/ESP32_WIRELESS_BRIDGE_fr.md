...
> **État de l'implémentation :** l'hébergement WLAN, la découverte du pont, les messages WebSocket et l'énumération physique USB sont implémentés. Les transferts USB-MIDI et la synchronisation CDC des presets constituent les prochaines étapes matérielles ; le firmware signale ces opérations comme indisponibles tant que leurs interfaces n'ont pas été validées avec une pédale.
